...
let api = function Binance(options = {}) {
  ...
  return {
    ...
    bswapPools: async (params = {}) => {
      return promiseRequest("v1/bswap/pools", params, {
        base: sapi,
        type: "SIGNED",
      });
    },
    ...
    bswapLiquidity: async (params = {}) => {
      return promiseRequest("v1/bswap/liquidity", params, {
        base: sapi,
        type: "SIGNED",
      });
    },

    bswapLiquidityAdd: async (params = {}) => {
      return promiseRequest("v1/bswap/liquidityAdd", params, {
        base: sapi,
        type: "SIGNED",
        method: "POST",
      });
    ...
    bswapLliquidityRemove: async (params = {}) => {
      return promiseRequest("v1/bswap/liquidityRemove", params, {
        base: sapi,
        type: "SIGNED",
        method: "POST",
      });
    ...
    bswapLiquidityOps: async (params = {}) => {
      return promiseRequest("v1/bswap/liquidityOps", params, {
        base: sapi,
        type: "SIGNED",
      });
    },
    ...
    bswapQuote: async (params = {}) => {
      return promiseRequest("v1/bswap/quote", params, {
        base: sapi,
        type: "SIGNED",
      });
    },
    ...
    bswapHistory: async (params = {}) => {
      return promiseRequest("v1/bswap/swap", params, {
        base: sapi,
        type: "SIGNED",
      });
    },
